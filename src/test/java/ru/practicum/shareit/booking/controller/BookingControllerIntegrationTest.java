...
class BookingControllerIntegrationTest {
    ...
    @SneakyThrows
    @Test
    void add_whenItemIdMissing_thenStatusIsBadRequest() {
        Long userId = 0L;
        BookingCreationDto bookingCreationDto = BookingCreationDto.builder()
                .start(LocalDateTime.now().plusHours(1))
                .end(LocalDateTime.now().plusHours(2))
    ...
    @SneakyThrows
    @Test
    void add_whenStartIsMissing_thenStatusIsBadRequest() {
        Long userId = 0L;
        BookingCreationDto bookingCreationDto = BookingCreationDto.builder()
                .itemId(0L)
                .end(LocalDateTime.now().plusHours(2))
    ...
    @SneakyThrows
    @Test
    void add_whenStartIsInPast_thenStatusIsBadRequest() {
        Long userId = 0L;
        BookingCreationDto bookingCreationDto = BookingCreationDto.builder()
                .itemId(0L)
    ...
    @SneakyThrows
    @Test
    void add_whenEndIsInMissing_thenStatusIsBadRequest() {
        Long userId = 0L;
        BookingCreationDto bookingCreationDto = BookingCreationDto.builder()
                .itemId(0L)
                .start(LocalDateTime.now().plusHours(1))
    ...
    @SneakyThrows
    @Test
    void add_whenEndIsInThePast_thenStatusIsBadRequest() {
        Long userId = 0L;
        BookingCreationDto bookingCreationDto = BookingCreationDto.builder()
                .itemId(0L)
                .start(LocalDateTime.now().plusHours(1))
    ...
    @SneakyThrows
    @Test
    void getByStateForBooker_whenStateIsMissing_thenDefaultValuePassedToService() {
        Long userId = 0L;
        ...
        assertEquals(defaultState, stateArgumentCaptor.getValue(),
                "Invalid state passed to service");
    }

    @SneakyThrows
    @Test
    void getByStateForBooker_whenSizeIsMissing_thenDefaultValuePassedToService() {
        Long userId = 0L;
        String state = "PAST";
        int from = 0;
        int defaultSize = 20;
    ...
    @SneakyThrows
    @Test
    void getByStateForBooker_whenFromIsMissing_thenDefaultValuePassedToService() {
        Long userId = 0L;
        String state = "PAST";
        int defaultFrom = 0;
        int size = 5;
    ...
    @SneakyThrows
    @Test
    void getByStateForItemOwner_whenStateIsMissing_thenDefaultValuePassedToService() {
        Long userId = 0L;
        String defaultState = "ALL";
        int from = 0;
        int size = 5;
    ...
    @SneakyThrows
    @Test
    void getByStateForItemOwner_whenSizeIsMissing_thenDefaultValuePassedToService() {
        Long userId = 0L;
        String state = "PAST";
        int from = 0;
        int defaultSize = 20;
    ...
    @SneakyThrows
    @Test
    void getByStateForItemOwner_whenFromIsMissing_thenDefaultValuePassedToService() {
        Long userId = 0L;
        String state = "PAST";
        int defaultFrom = 0;
        int size = 5;
